...
Code context: Ventilation ratios for Rio Rancho, NM attics should be checked against current mechanical exhaust additions.
...
Skylight curb flashing in Rio Rancho, NM should be sequenced before ridge cap replacement.
...
On-site sector marker: Sandoval County / elevation 5505 ft band — logged for map parity and ZIP-corridor verification.

Primary postal anchor 87121 with multi-ZIP overlap in Rio Rancho; field packets tag Sandoval County for county-grid reconciliation.
