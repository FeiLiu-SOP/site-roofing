...
Valley metal in Lafayette, IN should be reviewed whenever granule loss tracks the water line.

Material note: In Lafayette, IN, algae-resistant granules may be specified for north-facing slopes.

Risk flag: Layered roofs hide deck rot—budget time for discovery before final pricing.

FAQ: Do you replace decking? Rot or delamination is scoped only after exposed deck inspection.

Tip: Clear gutters and downspouts before winter freeze cycles in ZIP 47909.

Wind-zone note: Lafayette, IN exposure class can change starter-strip and cap nail schedules.

We coordinate Lafayette, IN roof reviews with photo logs, moisture notes, and realistic dry-in windows.
...
On-site sector marker: Tippecanoe County / ZIP 47904 sector — logged for map parity and ZIP-corridor verification.
