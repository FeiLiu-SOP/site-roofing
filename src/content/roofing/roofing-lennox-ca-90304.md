...
Risk flag: In Lennox, CA, interior stains may track from HVAC condensate rather than roof cladding.

Regulatory note: Lennox, CA projects may trigger ice-barrier upgrades when tear-off exposes qualifying eave depths.

Skylight curb flashing in Lennox, CA should be sequenced before ridge cap replacement.
...
On-site sector marker: Los Angeles County / elevation 82 ft band — logged for map parity and ZIP-corridor verification.
