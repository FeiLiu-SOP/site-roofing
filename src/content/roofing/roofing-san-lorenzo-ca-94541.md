...
Granule embedment loss on San Lorenzo, CA north slopes can precede mat exposure.

FAQ: Can you tarp only part of the roof? In San Lorenzo, CA, yes—if slope and anchor points support safe tie-offs.

Material note: Ridge vent external baffles reduce wind-driven rain intrusion at high exposure sites.

Step: document ice-barrier extent at eaves when code upgrades apply.

Wind-zone note: San Lorenzo, CA exposure class can change starter-strip and cap nail schedules.

Risk flag: Tile underlayment age in San Lorenzo, CA can fail independently of visible tile cracks.
...
On-site sector marker: Alameda County / elevation 26 ft band — logged for map parity and ZIP-corridor verification.
