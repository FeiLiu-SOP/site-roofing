...
Freeze-thaw cycles around Petersburg, VA stress nail pops along eaves and rake edges.

Regulatory note: Petersburg, VA projects may trigger ice-barrier upgrades when tear-off exposes qualifying eave depths.

Wind-zone note: Petersburg, VA exposure class can change starter-strip and cap nail schedules.

FAQ: Is sheathing included? Rot or delamination is scoped only after exposed deck inspection.

Step: compare shingle manufacturer wind-zone ratings for Petersburg, VA exposure class.
...
On-site sector marker: Petersburg County / ZIP 23806 sector — logged for map parity and ZIP-corridor verification.
