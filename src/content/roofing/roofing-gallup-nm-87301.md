...
Risk flag: In Gallup, NM, interior stains may track from HVAC condensate rather than roof cladding.

Material note: Architectural shingle bundles vary by exposure width—verify field counts per square.

Step: compare shingle manufacturer wind-zone ratings for Gallup, NM exposure class.

FAQ: Is partial dry-in possible? In Gallup, NM, yes—if slope and anchor points support safe tie-offs.
...
Primary postal anchor 87301 with multi-ZIP overlap in Gallup; field packets tag McKinley County for county-grid reconciliation.
