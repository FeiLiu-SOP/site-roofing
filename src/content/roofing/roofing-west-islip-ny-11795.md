...
Material note: In West Islip, NY, algae-resistant granules may be specified for north-facing slopes.

Risk flag: Layered roofs hide deck rot—budget time for discovery before final pricing.

FAQ: Do you replace decking? Rot or delamination is scoped only after exposed deck inspection.

Code context: Ventilation ratios for West Islip, NY attics should be checked against current mechanical exhaust additions.
...
On-site sector marker: Suffolk County / elevation 23 ft band — logged for map parity and ZIP-corridor verification.
