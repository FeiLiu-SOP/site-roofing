...
Wind-zone note: Miami Lakes, FL exposure class can change starter-strip and cap nail schedules.

Risk flag: Chimney counter-flashing failures often reopen after cosmetic shingle-only repairs.

Material note: Architectural shingle bundles vary by exposure width—verify field counts per square.

Low-slope sections in Miami Lakes, FL need positive drainage before membrane repairs are scoped.
...
On-site sector marker: Miami-Dade County / coords 25.9100, -80.3200 — logged for map parity and ZIP-corridor verification.
