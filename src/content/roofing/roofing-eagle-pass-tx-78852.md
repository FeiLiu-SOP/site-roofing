...
Regulatory note: Eagle Pass, TX projects may trigger ice-barrier upgrades when tear-off exposes qualifying eave depths.

Risk flag: Tile underlayment age in Eagle Pass, TX can fail independently of visible tile cracks.

FAQ: Do you replace decking? Rot or delamination is scoped only after exposed deck inspection.

Low-slope sections in Eagle Pass, TX need positive drainage before membrane repairs are scoped.
...
On-site sector marker: Maverick County / elevation 787 ft band — logged for map parity and ZIP-corridor verification.
