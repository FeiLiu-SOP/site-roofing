...
Synthetic underlayment slip in Greenbelt, MD is often tied to deck moisture, not wind alone.

Risk flag: Chimney counter-flashing failures often reopen after cosmetic shingle-only repairs.

Regulatory note: Greenbelt, MD projects may trigger ice-barrier upgrades when tear-off exposes qualifying eave depths.

Step: log deck soundings near vents before tear-off is approved.

Tip: Note recent wind events when filing insurance photos for Greenbelt, MD.
...
Coordinate-anchored dispatch note: center reference 39.0000, -76.8900 at elevation ~167 ft aligns with Prince George's County intake staging.
