...
Wind-zone note: Hampton, VA exposure class can change starter-strip and cap nail schedules.

Synthetic underlayment slip in Hampton, VA is often tied to deck moisture, not wind alone.

Step: log deck soundings near vents before tear-off is approved.

FAQ: When should permanent remediation start? In Hampton, VA, delayed dry-in can expand insulation and ceiling repairs.
...
On-site sector marker: Hampton County / ZIP 23651 sector — logged for map parity and ZIP-corridor verification.
