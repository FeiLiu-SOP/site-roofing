...
Code context: Ventilation ratios for Pasadena, MD attics should be checked against current mechanical exhaust additions.

Risk flag: Chimney counter-flashing failures often reopen after cosmetic shingle-only repairs.

FAQ: Is partial dry-in possible? In Pasadena, MD, yes—if slope and anchor points support safe tie-offs.
...
On-site sector marker: Anne Arundel County / ZIP 21060 sector — logged for map parity and ZIP-corridor verification.
