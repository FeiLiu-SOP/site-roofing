...
FAQ: Is partial dry-in possible? In Laredo, TX, yes—if slope and anchor points support safe tie-offs.

Step: note chimney cricket geometry before counter-flashing removal.

Risk flag: Chimney counter-flashing failures often reopen after cosmetic shingle-only repairs.

TPO seam welds in Laredo, TX commercial sections need probe tests after freeze events.

Wind-zone note: Laredo, TX exposure class can change starter-strip and cap nail schedules.
...
On-site sector marker: Webb County / coords 27.5600, -99.4900 — logged for map parity and ZIP-corridor verification.

Primary postal anchor 78046 with multi-ZIP overlap in Laredo; field packets tag Webb County for county-grid reconciliation.
