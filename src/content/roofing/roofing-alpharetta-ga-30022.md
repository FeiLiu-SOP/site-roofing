...
Risk flag: Tile underlayment age in Alpharetta, GA can fail independently of visible tile cracks.

We coordinate Alpharetta, GA roof reviews with photo logs, moisture notes, and realistic dry-in windows.

Permit note: Re-roof permits often require manufacturer installation bulletins and disposal manifests.

Tip: Ask whether step flashing is replaced or reused at wall intersections.

Wind-zone note: Alpharetta, GA exposure class can change starter-strip and cap nail schedules.
...
On-site sector marker: Fulton County / coords 34.0700, -84.2700 — logged for map parity and ZIP-corridor verification.
