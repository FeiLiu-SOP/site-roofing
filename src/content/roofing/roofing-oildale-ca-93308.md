...
Wind-zone note: Oildale, CA exposure class can change starter-strip and cap nail schedules.

Wood shake courses in Oildale, CA require skip-spacing rules at valleys.

Risk flag: Chimney counter-flashing failures often reopen after cosmetic shingle-only repairs.

FAQ: Is partial dry-in possible? In Oildale, CA, yes—if slope and anchor points support safe tie-offs.

Book a leak-tracing visit with attic and exterior photo logs. Serving ZIP Code: 93308.
...
On-site sector marker: Kern County / coords 35.4300, -119.0300 — logged for map parity and ZIP-corridor verification.
