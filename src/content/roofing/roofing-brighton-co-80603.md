...
Wind-zone note: Brighton, CO exposure class can change starter-strip and cap nail schedules.

Risk flag: In Brighton, CO, interior stains may track from HVAC condensate rather than roof cladding.

Tip: Photograph ceiling stains with a reference ruler before tarping.

Granule embedment loss on Brighton, CO north slopes can precede mat exposure.
...
Primary postal anchor 80603 with multi-ZIP overlap in Brighton; field packets tag Adams County for county-grid reconciliation.
