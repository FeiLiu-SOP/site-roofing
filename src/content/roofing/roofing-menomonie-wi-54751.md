...
Material note: In Menomonie, WI, algae-resistant granules may be specified for north-facing slopes.

Tip: Ask whether step flashing is replaced or reused at wall intersections.

Granule embedment loss on Menomonie, WI north slopes can precede mat exposure.

FAQ: Can you tarp only part of the roof? In Menomonie, WI, yes—if slope and anchor points support safe tie-offs.
