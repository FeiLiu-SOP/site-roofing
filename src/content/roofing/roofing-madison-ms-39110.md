...
Material note: In Madison, MS, algae-resistant granules may be specified for north-facing slopes.

Step: verify starter-strip alignment before field shingle exposure is set.

Wind-zone note: Madison, MS exposure class can change starter-strip and cap nail schedules.

Low-slope sections in Madison, MS need positive drainage before membrane repairs are scoped.
...
On-site sector marker: Madison County / elevation 344 ft band — logged for map parity and ZIP-corridor verification.
