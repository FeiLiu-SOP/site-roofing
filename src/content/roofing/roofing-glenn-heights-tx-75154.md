...
Wind-zone note: Glenn Heights, TX exposure class can change starter-strip and cap nail schedules.

Granule embedment loss on Glenn Heights, TX north slopes can precede mat exposure.
...
FAQ: Can you tarp only part of the roof? In Glenn Heights, TX, yes—if slope and anchor points support safe tie-offs.
...
On-site sector marker: Dallas County / elevation 689 ft band — logged for map parity and ZIP-corridor verification.
