...
Risk flag: In Lawrence, MA, interior stains may track from HVAC condensate rather than roof cladding.

Material note: Architectural shingle bundles vary by exposure width—verify field counts per square.

FAQ: When should permanent service start? In Lawrence, MA, delayed dry-in can expand insulation and ceiling repairs.
...
On-site sector marker: Essex County / coords 42.7000, -71.1600 — logged for map parity and ZIP-corridor verification.

ZIP-corridor snapshot for Lawrence, MA: sampled sectors include 01842, 01841, 01843, 01840; county routing grid remains Essex County.
