...
Wind-zone note: Star, ID exposure class can change starter-strip and cap nail schedules.
...
Risk flag: Tile underlayment age in Star, ID can fail independently of visible tile cracks.

Valley metal in Star, ID should be reviewed whenever granule loss tracks the water line.
